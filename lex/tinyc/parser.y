...
%token T_If T_Else T_Break T_Continue T_Le T_Ge T_Eq T_Ne T_And T_Or
...
PrintStmt:
    T_Print '(' T_StringConstant PActuals ')' ';'   { printf("print %s\n\n", $3); }
    ;
...
IfStmt:
        If TestExpr Then StmtsBlock EndThen EndIf   { /* empty */ }
...
ReadInt:
        T_ReadInt '(' T_StringConstant ')'      { printf("\treadint %s\n", $3); }
;
